...
load_data <- function(assay_name){
  file_name <- dir(pattern = paste0("MDD_", assay_name,"_","Level4"),recursive = TRUE, full.names = TRUE)
...
#####
plot_heatmap <- function(df, md, assay_name, show_row_names = FALSE, mark_rows = NULL, cluster_rows = TRUE){
...
plot_heatmap(GCP, md, assay_name = "GCP", show_row_names = TRUE, cluster_rows = FALSE)
