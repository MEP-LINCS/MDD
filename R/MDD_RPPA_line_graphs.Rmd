...
pdf(file = "../plots/MDD_RPPA_linegraphs_fig3B_w4pt5_h2.pdf", height =2, width = 4.5, useDingbats = FALSE)
p
res <- dev.off()

pdf(file = "../plots/MDD_RPPA_linegraphs_fig3B_w4pt5_h3.pdf", height =3, width = 4.5, useDingbats = FALSE)
p
res <- dev.off()

pdf(file = "../plots/MDD_RPPA_linegraphs_fig3B_w4pt5_h4.pdf", height =4, width = 4.5, useDingbats = FALSE)
p
res <- dev.off()
