...
pdf("../plots/MDD_GTEx_heatmap.pdf")
draw(hm_GTEx)
res <- dev.off

write_csv(tissue_module, "../tables/MDD_GTEx_heatmap_data.csv")
...
pdf("../plots/MDD_GTEx_heatmap_normalized.pdf")
draw(hm_GTEx_lfc_centered_both)
res <- dev.off

df <- tissue_module_dm_centered_both %>%
  as_tibble(rownames = "module")
write_csv(df, "../tables/MDD_GTEx_heatmap_normalized_data.csv")
