...
#Filter data to significant values based on adjusted p values
integrated_T0_DE <- integrated_T0_DE_all %>%
  filter(Type == "motifs"|paste0(feature, Type) %in% paste0(integrated_adj_p_values$feature, integrated_adj_p_values$Type))
