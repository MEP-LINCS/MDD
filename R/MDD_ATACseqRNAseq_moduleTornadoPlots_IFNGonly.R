...
dir <- "../plots/ATACseq_tornadoPlots/allModules/"
...
RNAseqL3Z_filtList <- lapply(moduleListHLAOrdered, function(x) {
  x <- RNAseqL3Z[x %>%
                 ...
                 sampleAnno %>%
                   filter(ligand %in% c("ctrl", "EGF", "IFNG"),
                          experimentalTimePoint %in% c(0, 48)) %>% 
...
pdf(sprintf("%s/MDD_%s_genes_RNAseqHeatmap_tornadoOrder.pdf", dir, names(RNAseqL3Z_filtList[1]),
            height = 10, width = 5))
HeatmapL3C(RNAseqL3Z_filtList[[1]],
           clust = FALSE, cluster_rows = FALSE, left_annotation = raList[[1]])
dev.off()

pdf(sprintf("%s/MDD_%s_genes_RNAseqHeatmap_tornadoOrder.pdf", dir, names(RNAseqL3Z_filtList[2]),
            height = 10, width = 5))
HeatmapL3C(RNAseqL3Z_filtList[[2]],
           clust = FALSE, cluster_rows = FALSE, left_annotation = raList[[2]])
dev.off()

pdf(sprintf("%s/MDD_%s_genes_RNAseqHeatmap_tornadoOrder.pdf", dir, names(RNAseqL3Z_filtList[3]),
            height = 10, width = 5))
HeatmapL3C(RNAseqL3Z_filtList[[3]],
           clust = FALSE, cluster_rows = FALSE, left_annotation = raList[[3]])
dev.off()

pdf(sprintf("%s/MDD_%s_genes_RNAseqHeatmap_tornadoOrder.pdf", dir, names(RNAseqL3Z_filtList[4]),
            height = 10, width = 5))
...
pdf(sprintf("%s/MDD_%s_genes_RNAseqHeatmap_tornadoOrder.pdf", dir, names(RNAseqL3Z_filtList[5]),
            height = 10, width = 5))
...
pdf(sprintf("%s/MDD_%s_genes_RNAseqHeatmap_tornadoOrder.pdf", dir, names(RNAseqL3Z_filtList[6]),
            height = 10, width = 5))
...
pdf(sprintf("%s/MDD_%s_genes_RNAseqHeatmap_tornadoOrder.pdf", dir, names(RNAseqL3Z_filtList[7]),
            height = 10, width = 5))
...
pdf(sprintf("%s/MDD_%s_genes_RNAseqHeatmap_tornadoOrder.pdf", dir, names(RNAseqL3Z_filtList[8]),
            height = 10, width = 5))
HeatmapL3C(RNAseqL3Z_filtList[[8]],
           clust = FALSE, cluster_rows = FALSE, left_annotation = raList[[8]])
dev.off()

pdf(sprintf("%s/MDD_%s_genes_RNAseqHeatmap_tornadoOrder.pdf", dir, names(RNAseqL3Z_filtList[9]),
            height = 10, width = 5))
HeatmapL3C(RNAseqL3Z_filtList[[9]],
           clust = FALSE, cluster_rows = FALSE, left_annotation = raList[[9]])
dev.off()

pdf(sprintf("%s/MDD_%s_genes_RNAseqHeatmap_tornadoOrder.pdf", dir, names(RNAseqL3Z_filtList[10]),
            height = 10, width = 5))
HeatmapL3C(RNAseqL3Z_filtList[[10]],
           clust = FALSE, cluster_rows = FALSE, left_annotation = raList[[10]])
dev.off()

pdf(sprintf("%s/MDD_%s_genes_RNAseqHeatmap_tornadoOrder.pdf", dir, names(RNAseqL3Z_filtList[11]),
            height = 10, width = 5))
HeatmapL3C(RNAseqL3Z_filtList[[11]],
           clust = FALSE, cluster_rows = FALSE, left_annotation = raList[[11]])
dev.off()

pdf(sprintf("%s/MDD_%s_genes_RNAseqHeatmap_tornadoOrder.pdf", dir, names(RNAseqL3Z_filtList[12]),
            height = 10, width = 5))
