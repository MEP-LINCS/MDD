...
ProbeMetadata <- read_delim("Data/GCP/ProbeMetadata.txt", 
                            "\t", escape_double = FALSE, trim_ws = TRUE)

mddMetadata <- read_csv("metadata/MDD_sample_annotations.csv")

GCP_Data <- read_tsv("Data/GCP/GCP_MCF10a_log2_noProbeMetadata.txt", skip = 2) %>%
  t() %>%
  as.tibble()
...
GCP_level4_file <- read_tsv("Data/GCP/MCF10a_EGFtimepointnorm_RepRemoved_withPBS_OHSU_metadata.txt", skip = 2) 
