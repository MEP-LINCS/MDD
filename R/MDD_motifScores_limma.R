...
motiflevel3File <- "../ATACseq/Data/MDD_ATACseq_MotifScores.csv"
...
write.csv(tt, sprintf("%s/motifScores_DE_topTables.csv", outDirData))
...
pdf(sprintf("%s/motifScores_significantAnalytes.pdf", outDirPlots), height = 12, width = 16)
hm <- Heatmap(resTP,
              name = "significant",
