...
RPPA_motif_rows <- which(df$Type %in% c("RPPA", "motifs", "GCP") | str_detect(df$feature, "_int_"))
...
p_mod9_edu <- ggplot(df, aes(x = module_value, y = phenotype_value)) +
 ...
 geom_point(aes(color = ligand, size = time), alpha = .9) +
  ...
  labs(title = "Module 9 EdU positive proportion vs module",
       x = "Module score",
       y = "EdU positive proportion score") +
...
if(create_pdfs) {
  pdf("../plots/MDD_combined14_module_9_EdU_scatterplots.pdf")
