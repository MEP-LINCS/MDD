...
cor_dm <- cor(if_module_dm, method ="spearman")

cor_hm <- Heatmap(cor_dm,
                   name = "spearman/ncorrelation ",
...
cor_dm <- cor(if_module_dm_reduced,  method ="spearman")
...
cor_dm <- cor(if_modules_dm, if_phenotypes_dm,  method ="spearman")
