...
The first local maximum is k = 3 which does not yield informative clusters. The second local maximum is k = `r clust_num-1` and k = `r clust_num` is the first value where the gap value minus its standard error is less than this local maximum.  
