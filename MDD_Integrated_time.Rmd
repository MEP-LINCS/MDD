...
The first local maximum is k = 4 which does not yield informative clusters. The second local maximum is k = `r clust_num-1`. This analysis is choosing to use k = `r clust_num` which is is the first value where the gap value minus its standard error is less than this local maximum at `r clust_num-1`.  
