...
selected_assay_pk_data <- bind_rows(ATACseq_selected, cycIF_values, GCP_selected, hallmark_pathways, IF_values, RNAseq_selected,  RPPA_selected, RPPA_pathways, TFs_values)
...
if(file.exists("R/selected_assay_pk_data_rr.rda")){
  ...
  selected_assay_pk_data_rr <-  bind_rows(ATACseq_selected_rr, cycIF_values_rr, GCP_selected_rr,  IF_values_selected_rr, RNAseq_selected_rr,  RPPA_selected_rr)
